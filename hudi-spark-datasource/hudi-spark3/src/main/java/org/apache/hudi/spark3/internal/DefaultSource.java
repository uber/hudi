...
public class DefaultSource extends BaseDefaultSource implements TableProvider {
  ...
  public Table getTable(StructType schema, Transform[] partitioning, Map<String, String> properties) {
    ...
    boolean populateMetaColumns = Boolean.parseBoolean(properties.getOrDefault(HoodieTableConfig.HOODIE_POPULATE_META_COLUMNS.key(),
    ...
    return new HoodieDataSourceInternalTable(instantTime, config, schema, getSparkSession(),
        getConfiguration(), populateMetaColumns, arePartitionRecordsSorted);
  }
}
