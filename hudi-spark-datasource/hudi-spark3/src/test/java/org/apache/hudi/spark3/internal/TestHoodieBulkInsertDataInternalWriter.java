...
public class TestHoodieBulkInsertDataInternalWriter extends
  ...
  public void testDataInternalWriter(boolean sorted, boolean populateMetaColumns) throws Exception {
    ...
    for (int i = 0; i < 5; i++) {
      ...
      HoodieBulkInsertDataInternalWriter writer = new HoodieBulkInsertDataInternalWriter(table, cfg, instantTime, RANDOM.nextInt(100000),
          RANDOM.nextLong(), STRUCT_TYPE, populateMetaColumns, sorted);
      ...
      assertOutput(totalInputRows, result, instantTime, fileNames, populateMetaColumns);
    }
  }
  ...
  public void testGlobalFailure(boolean populateMetaColumns) throws Exception {
    ...
    HoodieBulkInsertDataInternalWriter writer = new HoodieBulkInsertDataInternalWriter(table, cfg, instantTime, RANDOM.nextInt(100000),
        RANDOM.nextLong(), STRUCT_TYPE, populateMetaColumns, false);
